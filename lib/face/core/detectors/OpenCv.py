...
class OpenCvClient(Detector):
    ...
    def __build_cascade(self, model_name="haarcascade") -> Any:
        ...
        opencv_path=f"{os.getcwd()}/lib/face/data/haar_opencv/"
        logger.info(f"{opencv_path}=opencv_data_path")
        print(f"opencv_data_path=",opencv_path)
        if model_name == "haarcascade":
            face_detector_path = opencv_path + "haarcascade_frontalface_default.xml"
            print(f"face_detector_path=",face_detector_path)
