...
import numpy as np
import cv2
from lib.face.core.modules import detection
from lib.face.core.models.Detector import Detector, DetectedFace, FacialAreaRegion
from lib.face.core.detectors import (
    FastMtCnn,
    MediaPipe,
    MtCnn,
    OpenCv,
