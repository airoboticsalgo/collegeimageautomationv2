...
import gdown
import numpy as np
from lib.face.core.commons import package_utils, folder_utils
from lib.face.core.modules import verification
from lib.face.core.models.FacialRecognition import FacialRecognition
...
def load_model(
    ...
    output=f"{os.getcwd()}/lib/face/data/vgg/vgg_face_weights.h5"
    print(f"modelpath=={output}")
    logger.info(f"{output}=modelpath")
    if os.path.isfile(output) != True:
        logger.info("vgg_face_weights.h5 will be downloaded11...")
